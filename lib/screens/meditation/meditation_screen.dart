...
import 'wellness_detail_screen.dart';
import 'breathing_meditation_screen.dart';
import 'relaxing_sounds_page.dart';
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const RelaxingSoundsPage(),
                      ),
                    );
                  },
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Center(
                            child: Icon(Icons.headphones, size: 20, color: Colors.teal),
                          ),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Listen to calm sounds to reduce stress',
                                style: TextStyle(
                                  fontSize: 12,
                                  color: isDark
                                      ? Colors.grey.shade400
